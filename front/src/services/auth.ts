...
export class AuthService {
  ...
  public async sendEmailConfirmation(email: string, user_token: string): Promise<void> {
    return apiService.post('/auth/send-confirmation', { email, user_token });
  }

  public async confirmEmailAddress(user_token: string): Promise<any> {
    return await apiService.post('/auth/confirm-email', { user_token });
  }
