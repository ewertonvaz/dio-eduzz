...
import { postUserTokenValidator } from './validators/postUserTokenValidator';
...
app.post('/auth/send-confirmation', validateRequest(postSendResetValidator), AuthController.sendConfirmation);
app.post('/auth/confirm-email', validateRequest(postUserTokenValidator), AuthController.confirmEmail);
